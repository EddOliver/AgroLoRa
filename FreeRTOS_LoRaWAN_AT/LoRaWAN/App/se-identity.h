 ...
 */
#define LORAWAN_DEVICE_EUI                                 { YOUR_DEVICE_EUI_HERE }//{ 0x00, 0x80, 0xE1, 0x01, 0x01, 0x01, 0x01, 0x01 }

/*!
 * App/Join server IEEE EUI (big endian)
 */
#define LORAWAN_JOIN_EUI                                   { YOUR_APP_EUI_HERE }
 ...
 * Network root key
 */
#define LORAWAN_NWK_KEY                                    YOUR_APP_KEY_HERE
